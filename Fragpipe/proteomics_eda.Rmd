...
5. **Normalization**: Log2 transformation followed by quantile normalization
...
# Log2 transformation 
z_log2 <- log2(z_complete)

# Between-array normalization
z_normalized <- normalizeBetweenArrays(z_log2, method = "quantile")
...
# Raw data
boxplot(log2(z_complete), las = 2, main = "Raw Data (Log2 scale)", 
        cex.axis = 0.6, col = rainbow(ncol(z_complete)))

# Log2 transformed
boxplot(z_log2, las = 2, main = "Log2 Transformed", 
        cex.axis = 0.6, col = rainbow(ncol(z_log2)))
